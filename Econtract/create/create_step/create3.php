        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  <h1 class="h3 mb-4 text-gray-800 text-center">立書人</h1>

                    <fieldset>
                        <form class="user" action="./create4.php" method="POST">
                            <div class="form-group">
                                <?php
                                    $contract_person = $_POST['contract_person'];
                                    if ($contract_person == 'A') {
                                        echo "<label for='user_account_B'>乙方使用者帳號：</label><input type='text' class='form-control form-control-user' id='user_account_B' name='user_account_B' placeholder='Enter email address'>";
                                        echo "<input type='hidden' id='user_account_A' name='user_account_A' value='".$account."'>";
                                    } else if($contract_person == 'B'){
                                        echo "<label for='user_account_A'>甲方使用者帳號：</label><input class='form-control form-control-user' type='text' id='user_account_A' name='user_account_A'placeholder='Enter email address'>";
